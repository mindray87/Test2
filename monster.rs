/* An evil monster.
 A new monster has 100 health points. It gets weaker when
 the health is low. */
...
impl Monster {
    // Returns a monster with the specified strength.
    ...
    /* Returns the monster‘s current
     attack strength. If the monster
     has less than 20 health points,
      its attack is only
     half as strong. */
    ...
    according to the incoming attack’s
    strength. */
